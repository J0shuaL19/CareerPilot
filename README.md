...
Current features include a career dashboard, searchable job pipeline tracking, job activity timelines, PDF/DOCX resume import, searchable resume previews and version duplication, AI match analysis, and searchable saved analysis history.
