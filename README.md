...
Current features include a career dashboard, job pipeline tracking, job activity timelines, PDF/DOCX resume import and storage, AI match analysis, and searchable saved analysis history.
